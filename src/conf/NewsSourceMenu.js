  ...
  menu: [
    {
      ...
      items: [
        ...
        { id: "NS_GOOGLE_NEWS" },
        { id: "NS_NEWSWEEK" },
        { id: "NS_NEW_YORK_MAGAZINE" },
        { id: "NS_THE_ECONOMIST" },
        { id: "NS_TIME" },
        { id: "NS_REUTERS" },
        { id: "NS_ASSOCIATED_PRESS" },
        { id: "NS_INDEPENDENT" },
        { id: "NS_THE_TELEGRAPH" },
        { id: "NS_METRO" }
      ]
      ...
      caption: "Business",
      items: [
        { id: "NS_BUSINESS_INSIDER" },
        { id: "NS_BLOOMBERG" },
        { id: "NS_FINANCIAL_TIMES" },
        { id: "NS_CNBC"}
      ]
    },{
      caption: "Technology",
