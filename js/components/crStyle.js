...
const crTextLeftCn = className => crCn(className, "text-left");
exports.crTextLeftCn = crTextLeftCn;
...
const CL_DIALOG = exports.CL_DIALOG = crContainerBgCn(`dialog ${CL_BOX_SHADOW_5}`);
const crBoxShadowCn = className => crCn(className, CL_BOX_SHADOW_5);
exports.crBoxShadowCn = crBoxShadowCn;
const crPaneCn = className => crContainerBgCn(crCn("pane", className));
exports.crPaneCn = crPaneCn;
const crPopupMenuCn = className => crCn(crBoxShadowCn("popup-menu"), className);
