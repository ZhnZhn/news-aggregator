...
const crMenuQuery = (APP_TITLE, onNewsSources, onAbout, onClose) => {
  if (!_menuQuery) {
    ...
    _menuQuery = [{
      ...
      t: "Stock Market",
      items: [[`${_ProviderNames.ALPHA_VANTAGE}: Sentiment`, _crOnClick(_NewsQuery.default.AV)], [_ProviderNames.FMP_LONG, _crOnClick(_NewsQuery.default.FMP)], [_ProviderNames.MASSIVE, _crOnClick(_NewsQuery.default.MASSIVE)]]
    }, {
      t: "General News",
