...
var INITIAL_FROM_DATE = (0, _dt.getFromDate)(1),
  ...
  DF_TAG = "CSS",
  INPUT_CONFIGS = [['t', 'tag', (0, _DialogFn.crTextFieldCaption)('Tag', DF_TAG), DF_TAG, true], ['s', 'sortBy', 'SortBy', SORT_BY_OPTIONS, DF_SORT_BY, true], ['ft', '_ft', 'From To Date', INITIAL_FROM_DATE, INITIAL_TO_DATE]],
