...
const _CATEGORY = ['business', 'entertainment', 'general', 'health', 'science', 'sports', 'technology'],
  ...
  _crInputConfigs = () => [(0, _DialogFn.crInputSelectConfig)('category', CATEGORY_OPTIONS), (0, _DialogFn.crInputSelectConfig)('country', COUNTRY_OPTIONS, {
    dfOpyion: DF_COUNTRY
  })];
const getNewsApiTopConfig = (0, _DialogFn.fGetDialogConfig)(_crInputConfigs);
exports.getNewsApiTopConfig = getNewsApiTopConfig;
//# sourceMappingURL=crNewsApiTopDialog.js.map