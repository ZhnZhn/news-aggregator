...
var INITIAL_FROM_DATE = (0, _dt.getFromDate)(1),
  ...
  DF_TAGGED = 'CSS',
  DF_IN_TITLE = 'flexbox',
  INPUT_CONFIGS = [['t', 'tagged', (0, _DialogFn.crTextFieldCaption)('Tagged', DF_TAGGED), DF_TAGGED, true], ['t', 'inTitle', (0, _DialogFn.crTextFieldCaption)('In Title', DF_IN_TITLE), DF_IN_TITLE, true], ['s', 'sortBy', 'SortBy', SORT_BY_OPTIONS, DF_SORT_BY], ['ft', '_ft', 'From To Date', INITIAL_FROM_DATE, INITIAL_TO_DATE]],
