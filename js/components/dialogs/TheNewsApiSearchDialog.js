...
var SORT_BY_OPTIONS = [["PublishedAt", " published_at"], ["Relevancy", "relevance_score"]],
  ...
  DF_TERM = "Weather",
  INPUT_CONFIGS = [['t', 'search', "Term (Default: " + DF_TERM + ")", DF_TERM, void 0, true], ['s', 'category', 'Category', _TheNewsApiDialogFn.CATEGORY_OPTIONS, _TheNewsApiDialogFn.DF_CATEGORY, true], ['s', 'sortBy', 'SortBy', SORT_BY_OPTIONS, DF_SORT_BY]],
