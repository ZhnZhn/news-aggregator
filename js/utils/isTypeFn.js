...
exports.isUndef = exports.isTypeObj = exports.isStr = exports.isObj = exports.isNumber = exports.isNotEmptyArr = exports.isFn = exports.isBool = exports.isArr = void 0;
...
const isObj = v => v !== null && isTypeObj(v);
exports.isObj = isObj;
const isArr = exports.isArr = Array.isArray;
const isNotEmptyArr = value => isArr(value) && value.length > 0;
